...
/**
 * Records a payment to the supplier against one stock receipt's priced
 * items (see pendingEntityService.setPurchasePrice — a receipt only owes
 * for lines that have already been given a purchase price). Mirrors
