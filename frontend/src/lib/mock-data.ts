...
export const db = {
  ...
  customers: [
    ...
    {
      id: 'cust2',
      name: 'Bright Office Solutions',
      phone: '+92 321 4455667',
      email: 'info@brightoffice.pk',
      address: 'DHA Phase 5',
      creditLimit: 250000,
      openingBalance: 0,
    },
  ...
  vendors: [
    ...
    {
      id: 'ven2',
      name: 'TechSource Imports',
      phone: '+92 42 35778899',
      email: 'orders@techsource.pk',
      address: 'Shahdara',
      ntn: '7654321-0',
      openingBalance: 0,
    },
    {
      id: 'ven3',
      name: 'Paper & Co.',
      phone: '+92 42 35443322',
      email: 'hello@paperco.pk',
      address: 'Badami Bagh',
      ntn: '5556667-1',
    ...
    {
      id: 'ven4',
      name: 'Global Peripherals',
      phone: '+92 42 35112299',
      email: 'gp@global.pk',
      address: 'Township',
      openingBalance: 0,
    },
...
export function partyOutstanding(kind: 'customers' | 'vendors', id: string): number {
  ...
  return entries.reduce(
    (s, e) => s + (kind === 'customers' ? e.debit - e.credit : e.credit - e.debit),
    0,
  );
}
