...
const listWarehouses = asyncHandler(async (req, res) => {
  const warehouses = await warehouseService.listWarehouses(req.user, req.query.store);
...
const getWarehouse = asyncHandler(async (req, res) => {
  const warehouse = await warehouseService.getWarehouseForActor(req.user, req.params.id);
...
const updateWarehouse = asyncHandler(async (req, res) => {
  const warehouse = await warehouseService.updateWarehouse(req.user, req.params.id, req.body);
