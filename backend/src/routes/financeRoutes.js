...
router.post("/bank-accounts", MANAGE, createBankAccountValidator, validate, financeController.createBankAccount);
router.patch("/bank-accounts/:id", MANAGE, updateBankAccountValidator, validate, financeController.updateBankAccount);
router.delete("/bank-accounts/:id", MANAGE, idParamValidator, validate, financeController.deleteBankAccount);
router.get("/bank-accounts/:id/ledger", READ, idParamValidator, validate, financeController.bankLedger);
...
router.post("/payments/customer", MANAGE, receiveCustomerValidator, validate, financeController.receiveFromCustomer);
...
router.get("/ledgers/:kind/:id", READ, statementParamValidator, validate, financeController.partyStatement);
